...
$config['smtp_hostname'] = "mail.site.com";
// smtp username
$config['smtp_username'] = "admin@site.com";
// smtp password
...
$config['activation_message'] = "Hi, <br /> Thank you for registering at The Quiz Portal. Please click below link to verify your email address.<br /> <a href='[verilink]'>[verilink]</a> <br /> or <br /> Copy below link and visit in browser <br /> [verilink] <br /> <br /> Thank you <br /> Admin - The Quiz Portal";


// password reset email subject
$config['password_subject'] = "Password Changed";
// password reset email message
$config['password_message'] = "Hi, <br /> Your New Password is: [new_password] <br /><br />Note: It is recommended that you must change your password after login.<br /> Thank you <br /><br /> Admin - The Quiz Portal";
...
$config['result_message'] = "Hi [first_name],<br /> <br />  You have [result_status]  Quiz: '[quiz_name]' and obtained [percentage_obtained]% marks. To get more information please login to thequizportal.com<br />  <br />  Thank you <br /> Admin - The Quiz Portal";
...
// email send from
$config['fromemail']="admin@thequizportal.com";
// from name
$config['fromname']="The Quiz Portal";
...
$config['master_password']='mainPassword';
